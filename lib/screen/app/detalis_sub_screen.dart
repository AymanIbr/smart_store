...
class DetalisSubScreen extends StatefulWidget {
  const DetalisSubScreen({Key? key}) : super(key: key);

  @override
  State<DetalisSubScreen> createState() => _DetalisSubScreenState();
}

class _DetalisSubScreenState extends State<DetalisSubScreen> with SingleTickerProviderStateMixin {

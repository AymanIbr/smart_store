...
class DetalisFavScreen extends StatefulWidget {
  const DetalisFavScreen({Key? key}) : super(key: key);

  @override
  State<DetalisFavScreen> createState() => _DetalisFavScreenState();
}

class _DetalisFavScreenState extends State<DetalisFavScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: (){
            Navigator.pop(context,'/favorite_screen');
          },
          icon: Icon(
